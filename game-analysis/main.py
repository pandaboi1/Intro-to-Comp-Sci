...
plt.scatter(df_main["first_release_date"], df_main["user-rating-value"], color ="red", label = "User Ratings")
...
df_hype = df_hype.rename(colums = { "hype_count" : "total_hype" })

plt.bar(df_follow.index - BAR_WIDTH/2, df_follow["total_follows"], color = "blue", lable = "Number of Follows", width = BAR_WIDTH)
plt.bar(df_hype.index + BAR_WIDTH/2, df_follow["total_hype"], color = "red", lable = "Number of Hypes", width = BAR_WIDTH)
